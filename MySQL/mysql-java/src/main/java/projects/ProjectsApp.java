...
;				}
	...
	private void updateProjectDetails() {
		...
		// Print message for each field in object: string project name
		String projectName = getStringInput("Enter the project name [" + curProject.getProjectName() + "]"); 
		
		// Print message for each field in object: Big Decimal estimated hours
		BigDecimal estimatedHours = getDecimalInput("Enter the estimated hours[" + curProject.getEstimatedHours() + "]");
		
		// Print message for each field in object: Big decimal actual hours
		BigDecimal actualHours = getDecimalInput("Enter the actual hours[" + curProject.getActualHours() + "]");
		
		// Print message for each field in object: Integer difficulty
		Integer difficulty = getIntInput("Enter the project difficulty (1-5) [" + curProject.getDifficulty() + "]");
		
		// Print message for each field in object: String notes
