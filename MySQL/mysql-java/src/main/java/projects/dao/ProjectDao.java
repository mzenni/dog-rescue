...
public class ProjectDao extends DaoBase {
	...
	/*
	 * FetchAllProjects uses JDBC method to retrieve all project rows from table 
	 * The project rows are ordered by name
	 */
	...
	/* 
	 * FetchProjectById uses JDBC method calls to retrieve a single porject row and associated values
	 */
