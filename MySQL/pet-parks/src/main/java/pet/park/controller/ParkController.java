...
@RestController
@RequestMapping("/pet_park") // every method in this class must start with pet park 
@Slf4j
public class ParkController {
	
	@Autowired //  becomes managed bean 
	...
	@GetMapping("/contributor/{contributorId}/parl/{parkId}")
